...
describe('test Anime Client', () => {
  ...
  it('should get anime characters', async () => {
    const data = await client
      ...
      .then((response: JikanResponse<AnimeCharacter[]>) => response.data);
  ...
  it('should get anime staff', async () => {
    const data = await client
      .getAnimeStaff(1)
      .then((response: JikanResponse<AnimeStaff[]>) => response.data);
    expect(data.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('should get anime episodes', async () => {
    const data = await client
      .getAnimeEpisodes(1)
      .then((response: JikanResponse<AnimeEpisode[]>) => response.data);
    expect(data.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('should get anime videos', async () => {
    const data = await client
      .getAnimeVideos(1)
      .then((response: JikanResponse<AnimeVideos>) => response.data);
  ...
  it('should get anime pictures', async () => {
    const data = await client
      .getAnimePictures(1)
      .then((response: JikanResponse<AnimePicture[]>) => response.data);
    expect(data.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('should get anime statistics', async () => {
    const data = await client
      ...
      .then((response: JikanResponse<AnimeStatistics>) => response.data);
